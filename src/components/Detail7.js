...
function Detail7() {
  return (
    <Container>
        ...
        <SubTitle>
        2021 * 15m * Family, Fantasy, Kids, Animation, Adventure
        </SubTitle>
        <Description>
        "Cinderella" is a classic animated fairy tale film produced by Walt Disney Productions and released in 1950. It is the 12th animated feature in the Walt Disney Animated Classics series and remains one of Disney's most iconic and beloved films.       </Description>
...
min-height: calc(100vh - 70px); //area of Detail7 page as header stays
