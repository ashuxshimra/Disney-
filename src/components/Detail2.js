...
function Detail2() {
  return (
    <Container>
      ...
      {/* Image Title */}
      <ImgTitle>
        <img src='https://clipart-library.com/img1/901059.png' />
      </ImgTitle>
      {/* Controls */}
      <Controls>
        <PlayButton>
      ...
      {/* SubTitle */}
      <SubTitle>
        2019 * 10m * Family, Fantasy, Kids, Animation, Dreams
      </SubTitle>
      {/* Description */}
      <Description>
        "Frozen" is a popular Disney animated musical fantasy film released in 2013. The movie was directed by Chris Buck and Jennifer Lee and produced by Walt Disney Animation Studios. It is the 53rd animated feature in the Walt Disney Animated Classics series.
      </Description>
    </Container>
  );
}
...
const Container = styled.div`
  min-height: calc(100vh - 70px); // Area of Detail2 page as header stays
