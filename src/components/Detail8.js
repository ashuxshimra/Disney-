...
function Detail8() {
  return (
    <Container>
        ...
        <SubTitle>
        2008 * 7m * Family, Fantasy, Kids, Love, Magic 
        </SubTitle>
        <Description>
        "Aladdin" is a beloved animated musical film produced by Walt Disney Animation Studios and released in 1992. It is based on the Middle Eastern folktale from "One Thousand and One Nights," specifically the story of "Aladdin and the Magic Lamp."       </Description>
...
min-height: calc(100vh - 70px); //area of Detail8 page as header stays
